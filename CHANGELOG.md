...
### Added
- Quit warning when pressing 'q' or 'esc' (#143)

### Changed
- Migrated from Make to `just` for CI/CD (#136)
- Updated Flux CRDs to the latest versions (#135)

### Fixed
- Resolved vulnerability reported by `cargo audit` (#138)
