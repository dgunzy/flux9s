...
// kopium command: kopium --filename /tmp/tmp.OPP0bpwf7Q/doc1.yaml --derive Default --derive PartialEq --docs --smart-derive-elision
...
pub struct ResourceSetInputProviderSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selectors: Option<Vec<ResourceSetInputProviderSelectors>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceSetInputProviderSelectors {
    ...
    pub match_expressions: Option<Vec<ResourceSetInputProviderSelectorsMatchExpressions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceSetInputProviderSelectorsMatchExpressions {
