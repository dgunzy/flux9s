...
// kopium command: kopium --filename /tmp/tmp.7eZHJEID9F/doc1.yaml --derive Default --derive PartialEq --docs --smart-derive-elision
...
// WARNING: generated by kopium - manual changes will be overwritten
// kopium command: kopium --filename /tmp/tmp.7eZHJEID9F/doc2.yaml --derive Default --derive PartialEq --docs --smart-derive-elision
// kopium version: 0.22.5
