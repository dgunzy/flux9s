...
// kopium command: kopium --filename /tmp/tmp.vutMK84DoG/doc1.yaml --derive Default --derive PartialEq --docs --smart-derive-elision
...
// WARNING: generated by kopium - manual changes will be overwritten
// kopium command: kopium --filename /tmp/tmp.vutMK84DoG/doc2.yaml --derive Default --derive PartialEq --docs --smart-derive-elision
// kopium version: 0.24.1
