...
// kopium command: kopium --filename /tmp/tmp.VTxcLFPRGL/doc1.yaml --derive Default --derive PartialEq --docs --smart-derive-elision
...
// WARNING: generated by kopium - manual changes will be overwritten
// kopium command: kopium --filename /tmp/tmp.VTxcLFPRGL/doc2.yaml --derive Default --derive PartialEq --docs --smart-derive-elision
// kopium version: 0.24.0
